...
def main():
    print("=" * 60)
    print("[B] QSOT Paper Data Generation: Velocity Sweep")
    print("=" * 60)
    ...
    for i, v in enumerate(velocities):
        ...
        try:
            ...
            if ent_file.exists() and mem_file.exists():
                ...
                print("   [!] Missing output files, using 0.0")
    ...
    # Title and legend
    plt.title(
        "Relativistic Quantum Decay & Memory Dynamics\n(QSOT Compiler v1.2.3)",
        fontsize=14,
        fontweight="bold",
        pad=20,
    )
    ...
    with open(csv_path, "w") as f:
        ...
        for v, e, m in zip(velocities, entanglements, memory_measures, strict=True):
    ...
    print("2. Analyze critical velocity (sudden death point)")
    print("3. Begin Paper B draft with this data")
